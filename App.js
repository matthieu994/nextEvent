...
export default class App extends React.Component {
	...
	componentDidMount() {
		...
		// 	.auth()
		// 	.signInAnonymously()
		// 	.then(user => console.warn("User -> ", user.toJSON()))
		// 	.catch(error => console.warn("Erreur de connexion", error));

		// firebase
		// 	.auth()
		// 	.createUserWithEmailAndPassword("nograe117@gmail.com", "Matthieu.test12")
		// 	.then(user => {
		// 		console.warn("User: ", user.toJSON());
		// 		user.sendEmailVerification();
		// 	})
		// 	.catch(error => console.warn("Erreur de connexion", error.code));
